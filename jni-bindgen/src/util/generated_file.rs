use std::fs::*;
use std::io::{self, BufRead, BufReader, Cursor, ErrorKind, Seek, SeekFrom, Write};
...
impl<'a> GeneratedFile<'a> {
    ...
    pub fn clobber(mut self) -> io::Result<PathBuf> {
        ...
        context.files.commit(rewrite, path.to_owned())
    }
    ...
    pub fn find_difference(&mut self) -> io::Result<Option<Difference>> {
        ...
        let mut rewrite = Cursor::new(&self.rewrite[..]);
