...
#[test] fn jni_descriptor_from_str() {
    ...
    assert_eq!(d.next(), Some(JniDescriptorSegment::Parameter(JniField::Single(JniBasicType::Class("android/net/Uri")))));
    assert_eq!(d.next(), Some(JniDescriptorSegment::Parameter(JniField::Array { levels: 1, inner: JniBasicType::Class("java/lang/String") })));
    assert_eq!(d.next(), Some(JniDescriptorSegment::Parameter(JniField::Single(JniBasicType::Class("java/lang/String")))));
    assert_eq!(d.next(), Some(JniDescriptorSegment::Parameter(JniField::Array { levels: 1, inner: JniBasicType::Class("java/lang/String") })));
    assert_eq!(d.next(), Some(JniDescriptorSegment::Parameter(JniField::Single(JniBasicType::Class("java/lang/String")))));
    assert_eq!(d.next(), Some(JniDescriptorSegment::Return(JniField::Single(JniBasicType::Class("android/database/Cursor")))));
    ...
    assert_eq!(d.next(), Some(JniDescriptorSegment::Parameter(JniField::Array { levels: 1, inner: JniBasicType::Class("java/lang/String") })));
    assert_eq!(d.next(), Some(JniDescriptorSegment::Parameter(JniField::Single(JniBasicType::Class("java/lang/String")))));
    assert_eq!(d.next(), Some(JniDescriptorSegment::Parameter(JniField::Single(JniBasicType::Class("android/os/CancellationSignal")))));
    assert_eq!(d.next(), Some(JniDescriptorSegment::Return(JniField::Single(JniBasicType::Class("android/database/Cursor")))));
    assert_eq!(d.next(), None);
    assert_eq!(d.next(), None);
    ...
    assert_eq!(d.next(), Some(JniDescriptorSegment::Parameter(JniField::Single(JniBasicType::Class("android/net/Uri")))));
    assert_eq!(d.next(), Some(JniDescriptorSegment::Parameter(JniField::Array { levels: 1, inner: JniBasicType::Class("java/lang/String") })));
    assert_eq!(d.next(), Some(JniDescriptorSegment::Parameter(JniField::Single(JniBasicType::Class("android/os/Bundle")))));
    assert_eq!(d.next(), Some(JniDescriptorSegment::Parameter(JniField::Single(JniBasicType::Class("android/os/CancellationSignal")))));
    assert_eq!(d.next(), Some(JniDescriptorSegment::Return(JniField::Single(JniBasicType::Class("android/database/Cursor")))));
    assert_eq!(d.next(), None);
    assert_eq!(d.next(), None);
